  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="订单变化" prop="order_number"></el-table-column>
    ...
    <!--查看订单进度对话框-->
    <el-dialog title="订单进度" :visible.sync="progressDialogVisible" width="40%">
      <el-timeline>
        <el-timeline-item
...
export default {
  ...
  methods: {
    ...
    async progressDialog() {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('获取订单进度失败')
      }
